...
Report bugs at https://github.com/frostraptor/smart-investor/issues
...
https://github.com/frostraptor/smart-investor/issues.
...
Ready to contribute? Here's how to set up `smart-investor` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `smart-investor` repo on GitHub.
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/smart-investor.git
